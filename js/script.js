...
var formularioValido = validarNome() && confereCPF && TelCelular && TelResidencial();

var TelCelular = telefone_cel;
var regex = new RegExp('^\\(((1[1-9])|([2-9][0-9]))\\)((3[0-9]{3}-[0-9]{4})|(9[0-9]{3}-[0-9]{5}))$'); 
if (regex.test(telefone_cel)) { 
    return true;
}
else alert("Telefone Inválido");
}
function TelResidencial (telefone_res) {
  var regex = new RegExp('^\\([0-9]{2}\\)((3[0-9]{3}-[0-9]{4})|(9[0-9]{3}-[0-9]{5}))$');
  return regex.test(telefone_res);
  return false;
